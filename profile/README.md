...
- **[Chive Indexer](https://github.com/chive-recipes/chive-indexer):** A private polling mechanism that compiles discovery indices (`index.json`). It generates daily automated Pull Requests to the public repo, enabling vetted user generated content to be indexed by the app.
